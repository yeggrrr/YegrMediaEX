...
class MediaViewController: UITabBarController {
    ...
    func setupTabBar() {
        ...
        thirdVC.tabBarItem = UITabBarItem(title: "저장한 콘텐츠 목록", image: UIImage(systemName: "square.and.arrow.down"), selectedImage: UIImage(systemName: "square.and.arrow.down.fill"))
